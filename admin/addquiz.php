...
if(mysqli_num_rows($result) > 0 ){
        $sub_id = $question = $option1 =  $option2 = $option3  = $option4  = $correctoption = null;
        header( "Location: ../adminpanel.php?addMcqs&quizAlreadyExist" );
    }else{
    $query = "INSERT INTO questions(question,option1,option2,option3,option4,correctoption,q_sub_id) VALUES('{$question}','{$option1}','{$option2}','{$option3}','{$option4}','{$correctoption}',{$sub_id})";

...
CREATE TABLE entrytest.topic(topic_id int(3) PRIMARY KEY, topic_name varchar(255) NOT NULL,topic_sub_id int(3) NOT NULL, FOREIGN KEY(topic_sub_id) REFERENCES subject(sub_id)); 